...
var api = {
  ...
  token: "53c97de83dd9dfb2543030dd6c0281f0", // TODO 0 add your api key
  ...
  posterUrl: function(movie) {
    ...
    var img_url = movie.poster_path
    var movie_poster = "http://image.tmdb.org/t/p/w300/" +img_url
...
function render() {
  ...
  model.watchlistItems.forEach(function(movie) {
    ...
    watchButton.addClass("btn btn-danger");
    // TODO 4a
    // add a poster image and append it inside the 
    // panel body above the button
    var poster =$("<img></img").prop('src',api.posterUrl(movie))
    poster.addClass("img-responsive")

    // TODO 2g
    // re-implement the li as a bootstrap panel with a heading and a body
    panelHead = $('<div>').append(title).addClass('panel-heading')
    panelBody =$('<div>').append(poster).append(watchButton).addClass('panel-body')
    var itemView = $("<li></li>")
      .append(panelHead)
      .append(panelBody)
  ...
  model.browseItems.forEach(function(movie) {
    ...
    var itemView = $("<li></li>").addClass('list-group-item')
      .append(title)
      .append(overview)
      .append(button);
